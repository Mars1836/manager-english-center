...
app.controller('index', function ($scope, $rootScope, $http, DTOptionsBuilder, DTColumnBuilder) {
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('Class').withTitle('Lớp').renderWith(function (data, type) {
            return data;
        }),
        DTColumnBuilder.newColumn('Absent').withTitle('Số buổi còn lại').renderWith(function (data, type) {
            return data;
        }),
        DTColumnBuilder.newColumn('learned').withTitle('Tổng số buổi')./*withOption('sWidth', '30px').*/renderWith(function (data, type) {
            return data;
        }),
        DTColumnBuilder.newColumn('Absent').withTitle('Số học viên').renderWith(function (data, type) {
            return data;
        }),
